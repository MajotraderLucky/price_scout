...
**Результаты с Archbook (резидентный IP):**
...
| Citilink  | [X] CAPTCHA   | -           | Блокирует headless     |
| DNS-Shop  | [X] 403       | -           | Блокирует headless     |

**Вывод:** Резидентный IP помогает, но Citilink/DNS блокируют headless браузеры
