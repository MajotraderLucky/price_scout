...
**Результаты stealth-тестирования:**
- regard.ru - [+] ОБХОД УСПЕШЕН (144,400 RUB)
- Citilink, DNS, Kotofoto - [X] Stealth не помогает (CAPTCHA на главной)

**Для обхода оставшихся магазинов нужно:**
1. 2Captcha API (~$3 для теста)
